...
describe("TabelaJogos", () => {
  ...
  it("renders the title with the current rodada", () => {
    ...
    // Check if the title is rendered with the correct rodada
  ...
  it("renders the games for the current rodada", () => {
    ...
    // Check if the games are rendered
    expect(screen.getByText("2 x 1")).toBeInTheDocument(); // Score for Team A vs Team B
  ...
  it("renders an empty state when there are no games", () => {
    ...
    // Check that no games are rendered
