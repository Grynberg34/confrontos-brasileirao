...
jest.mock('next/link', () => {
  ...
  Link.displayName = 'NextLink'; // Add displayName to the mocked component
  return Link;
});
...
describe('Tools Component', () => {
  it('renders all links with correct text and titles', () => {
    ...
    // Check if all links are rendered with the correct text
    ...
    // Check if all links have the correct titles
